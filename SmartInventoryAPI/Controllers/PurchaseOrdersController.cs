...
public class PurchaseOrdersController : ControllerBase
{
    ...
    [HttpPost("{id}/confirm")]
    public async Task<ActionResult<ApiResponseDto<PurchaseOrderDetailDto>>> ConfirmPurchaseOrder(long id)
    {
        var po = await _poService.ConfirmPurchaseOrderAsync(id);
        return Ok(new ApiResponseDto<PurchaseOrderDetailDto>
        {
            Success = true,
    ...
    [HttpPost("{id}/cancel")]
    public async Task<ActionResult<ApiResponseDto<PurchaseOrderDetailDto>>> CancelPurchaseOrder(long id)
    {
        var po = await _poService.CancelPurchaseOrderAsync(id);
        return Ok(new ApiResponseDto<PurchaseOrderDetailDto>
        {
            Success = true,
    ...
    public async Task<ActionResult<ApiResponseDto<PurchaseOrderDetailDto>>> ReceiveItem(
        long id,
        long itemId,
        [FromQuery] decimal receivedQuantity)
    {
        var po = await _poService.ReceiveItemAsync(id, itemId, receivedQuantity);
        return Ok(new ApiResponseDto<PurchaseOrderDetailDto>
        {
            Success = true,
    ...
    public async Task<ActionResult<ApiResponseDto<PurchaseOrderDetailDto>>> CancelItemWithReturn(
        ...
        long itemId)
    {
        var po = await _poService.CancelItemWithReturnAsync(id, itemId);
        return Ok(new ApiResponseDto<PurchaseOrderDetailDto>
        {
            Success = true,
