    ...
    try {
      ...
      return (
        response.data?.data?.map((forecast: any) => ({
          ...
          QtyConsumption30Days_Y1: forecast.QtyConsumptionPast30Days_Y1 || 0,
          QtyConsumption30Days_M5: forecast.QtyConsumptionPast30Days_M5 || 0,
          QtyConsumption30Days_M4: forecast.QtyConsumptionPast30Days_M4 || 0,
          QtyConsumption30Days_M3: forecast.QtyConsumptionPast30Days_M3 || 0,
          QtyConsumption30Days_M2: forecast.QtyConsumptionPast30Days_M2 || 0,
          QtyConsumption30Days_M1: forecast.QtyConsumptionPast30Days_M1 || 0,
          QtyConsumption30Days: forecast.QtyConsumptionPast30Days || 0,
